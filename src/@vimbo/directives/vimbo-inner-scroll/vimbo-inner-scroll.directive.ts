...
export class VimboInnerScrollDirective implements OnInit, OnDestroy {
    // Private
    private _parent: any;
     ...
     * @param {VimboMatchMediaService} _vimboMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _vimboMediaMatchService: VimboMatchMediaService,
    ...
    ngOnInit(): void {
        ...
        this._vimboMediaMatchService.onMediaChange
