...
import {
    VimboPerfectScrollbarGeometry,
    VimboPerfectScrollbarPosition
} from '@vimbo/directives/vimbo-perfect-scrollbar/vimbo-perfect-scrollbar.interfaces';
import { VimboConfigService } from '@vimbo/services/config.service';
import { VirtualDOMService } from '../../services/virtual-dom.service';

@Directive({
    selector: '[vimboPerfectScrollbar]'
})
export class VimboPerfectScrollbarDirective
     ...
     */
    @Input()
    set vimboPerfectScrollbarOptions(value) {
        // Merge the options
    ...
    get vimboPerfectScrollbarOptions(): any {
        // Return the options
    ...
    ngAfterViewInit(): void {
        ...
        if (this.vimboPerfectScrollbarOptions.updateOnRouteChange) {
            this._router.events
                .pipe(
    ...
    _init(): void {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.vimboPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): VimboPerfectScrollbarGeometry {
        return new VimboPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): VimboPerfectScrollbarPosition {
        if (!absolute && this.ps) {
            return new VimboPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        } else {
    ...
    animateScrolling(target: string, value: number, speed?: number): void {
        if (typeof window !== 'undefined' && this._animation) {
